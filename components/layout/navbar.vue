<template>
  <header
    ...
    <nav class="flex justify-between items-center mx-4 md:mx-8 xl:mx-auto py-6 md:py-8 w-auto xl:w-4/5">
      <NuxtLink to="/">
        <svg class="w-auto h-5 md:h-7" viewBox="0 0 726 141" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="hidden md:group-hover:flex gap-5 mx-auto py-4 w-[80%]">
      <div
        ...
        <ul class="text-neutral-2">
          <li
            v-for="item in solution.items" :key="item.id"
