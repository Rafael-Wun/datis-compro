<template>
  <footer class="pt-10 text-xs text-neutral-9 bg-neutral-2">
    <div class="space-y-10 mx-4 md:mx-auto md:w-11/12 xl:w-4/5">
      <div class="flex flex-col md:flex-row justify-center md:justify-between items-center md:items-start gap-5 md:gap-10">
        <div class="flex flex-col items-center md:items-start gap-4 w-full md:w-auto">
          <NuxtLink to="/">
            <svg class="w-auto h-6" viewBox="0 0 726 141" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-3">
              <span class="min-w-6 size-6 fill-neutral-9 icon-[ph--map-pin]"></span>
              <span>Ruko Citywalk Blok C/8<br>Jl. Kresek Raya No. 88, Duri Kosambi<br>Jakarta Barat 11750, Indonesia</span>
            </div>
            <div class="flex items-center gap-3">
              <span class="min-w-6 size-6 fill-neutral-9 icon-[ph--phone]"></span>
              <span>(021) 2252 4635</span>
            </div>
            <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col items-center md:items-start gap-5 pt-5 md:pt-0 w-full md:w-auto border-t md:border-0">
